...
class LoginActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        (binding.editText3).addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {//타이핑 시 2번째로 작동
                if((name.equals("")||number.equals("")||major.equals(""))==false)
                    binding.login.setEnabled(true)
            }

            override fun beforeTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {//타이핑 시 제일 먼저 작동
                if((name.equals("")||number.equals("")||major.equals(""))==false)
                    binding.login.setEnabled(true)
            }
        })
